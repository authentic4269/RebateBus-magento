...
class Quote extends AbstractExtensibleModel implements \Magento\Quote\Api\Data\CartInterface
{
    ...
    /**
     * @var \Magento\Quote\Model\ResourceModel\Rebate\CollectionFactory
     */
    protected $_quoteRebateCollectionFactory;
    ...
    public function __construct(
        ...
        \Magento\Quote\Model\ResourceModel\Rebate\CollectionFactory $quoteRebateCollectionFactory,
	\Magento\Quote\Model\RebateFactory $rebateFactory,
    ...
    /**
     * Retrieve quote rebates collection
     *
     * @param bool $useCache
     * @return  \Magento\Eav\Model\Entity\Collection\AbstractCollection
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     */
    public function getRebatesCollection($useCache = true)
    { /*
        if ($this->hasRebatesCollection()) {
            return $this->getData('items_collection');
        }
        if (null === $this->_items) {
            $this->_rebates = $this->_quoteRebateCollectionFactory->create();
    ...
    /**
     * Lists rebates in the cart.
     *
     * @return \Magento\Quote\Api\Data\RebateItemInterface[]|null Array of rebates. Otherwise, null.
     */
    ...
    /**
     * Adds rebate to the cart.
     *
     * @param \Magento\Quote\Api\Data\CartItemInterface[] $items
     * @return $this
     */
    public function addRebate($rebateCode, $quoteItem, $maxqty, $amount) {
        $item->setQuote($this);
        if (!$item->getId()) {
            $this->getRebatesCollection()->addRebate($item);
        }
        return $this;
     ...
     *
    */
    public function removeRebate($rebateCode) {
	...
	foreach ($quote->getRebates() as $rebate) {
