...
class Rebatebus_Rebate_Block_Cart extends Mage_Core_Block_Template
{

    public function hasRebates() {
	Mage::log("in has rebates", null, "rebatebus.log");
	foreach ($this->getItems() as $item) {
	 	$rebate = Mage::getModel('rebate/quote_item_rebate')->load($item->getId(), 'item_id');
		if ($rebate) {
			return $rebate->getVerification();		
		}
	}
	return false;
    }		
