...
interface TotalsInterface extends \Magento\Framework\Api\ExtensibleDataInterface
{
    ...
    /*
    *	Get rebates in the cart
    * @return \Magento\Quote\Api\Data\TotalsRebateInterface[]|null
    */
    public function getRebates();

    /*
	Deletes the rebate identified by $rebateCode from the cart
	@param string $rebateCode
	@return $this
    */
    public function deleteRebate($rebateCode);

    /*
    * Set applied rebate for quoteItem	
    */
